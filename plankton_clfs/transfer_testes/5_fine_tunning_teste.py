...
X_train = np.load("./laps_images_train_ffilter_2-3.npy")
y_train = np.load("./laps_real_labels_train_ffilter_2-3.npy")

X_valid = np.load("./laps_images_valid_ffilter_2-3.npy")
y_valid = np.load("./laps_real_labels_valid_ffilter_2-3.npy")
...
shape_clas = np.shape(y_valid)
num_classes= shape_clas[1]
