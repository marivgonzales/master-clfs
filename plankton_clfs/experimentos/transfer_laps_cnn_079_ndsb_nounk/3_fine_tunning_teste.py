...
with open("./model_fine_tuning_teste_3.json","w") as json_file:
    json_file.write(model_json)
print('Saved trained model at model_fine_tuning_teste_3.hdf5 and model_fine_tuning_teste_3.json')

predictions_valid = model.predict(X_valid, batch_size=batch_size)
predicted_labels_valid = np.argmax(predictions_valid, axis=1)
np.save("./complete_predictions_valid_ftteste3.npy", predictions_valid)
np.save("./predicted_labels_valid_ftteste3.npy", predicted_labels_valid)
np.save("./real_labels_valid_ftteste3.npy", y_valid)


predictions = model.predict(X_train, batch_size=batch_size)
predicted_labels = np.argmax(predictions, axis=1)
np.save("./complete_predictions_train_ftteste3.npy", predictions)
np.save("./predicted_labels_train_ftteste3.npy", predicted_labels)
np.save("./real_labels_train_ftteste3.npy", y_train)
