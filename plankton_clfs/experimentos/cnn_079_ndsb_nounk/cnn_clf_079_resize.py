...
model_path = "./ndsb_dataset/best_model_079.hdf5" 
...
with open("./ndsb_dataset/model_079.json","w") as json_file:
...
np.save("./ndsb_dataset/complete_predictions_079_valid.npy", predictions_valid)
np.save("./ndsb_dataset/predicted_labels_079_valid.npy", predicted_labels_valid)
np.save("./ndsb_dataset/real_labels_079_valid.npy", y_valid)


predictions = model.predict(X_train, batch_size=batch_size)
predicted_labels = np.argmax(predictions, axis=1)
np.save("./ndsb_dataset/complete_predictions_079_train.npy", predictions)
np.save("./ndsb_dataset/predicted_labels_079_train.npy", predicted_labels)
np.save("./ndsb_dataset/real_labels_079_train.npy", y_train)
