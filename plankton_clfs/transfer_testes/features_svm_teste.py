...
def load_data():
    train_path = "./laps_nobg_100/features_nounk_079_teste.npy"
...
clf = GridSearchCV(svm.SVC(C=1), tuned_parameters, cv=5 , verbose=1)
...
np.save("./laps_nobg_100/predictions_transfer_079_nounk_teste.npy", y_pred)
np.save("./laps_nobg_100/real_labels_transfer_079_nounk_teste.npy", y_true)
